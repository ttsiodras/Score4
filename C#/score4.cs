    ...
    class Program
    {
        ...
        public class Board {
            ...
            public Board() {
                ...
                /* no need - C# auto-inits to 0 (Barren)
                for(int y=0; y<height; y++)
                    for(int x=0; x<width; x++)
                        _slots[y,x] = Mycell.Barren;*/
            }
        };

        public static bool inside(int y, int x)
        {
        ...
        {  
	    // diagonal, down-right
            int[,] negativeSlope = { {0,0}, {1,1},   {2,2},   {3,3}   };
	    // diagonal, up-right
	    int[,] positiveSlope = { {0,0}, {-1,1},  {-2,2},  {-3,3}  }; 
